...
function normalize(input) {
    ...
    return {
        ...
        kind: ((_d = input.kind) !== null && _d !== void 0 ? _d : "direct_instruction"),
        duration_minutes: (_e = input.duration_minutes) !== null && _e !== void 0 ? _e : null,
        grouping: (_f = input.grouping) !== null && _f !== void 0 ? _f : null,
        resources: Array.isArray(input.resources)
            ? input.resources.filter((v) => typeof v === "string")
            : [],
...
export async function listLessonActivities(planId, tenantId, opts) {
    var _a, _b, _c;
...
export async function upsertLessonActivity(tenantId, input) {
