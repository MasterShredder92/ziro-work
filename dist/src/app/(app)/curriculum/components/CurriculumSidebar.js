...
export const CURRICULUM_NAV = [
    { id: "overview", label: "Overview", href: "#overview", description: "Programs & KPIs" },
    { id: "programs", label: "Programs", href: "#programs", description: "All programs" },
    { id: "levels", label: "Levels", href: "#levels", description: "Structure" },
    { id: "lessons", label: "Lessons", href: "#lessons", description: "Content" },
    { id: "progress", label: "Student Progress", href: "#progress", description: "Completion" },
];
export function CurriculumSidebar({ tenantLabel }) {
    const [active, setActive] = useState("overview");
    return (_jsxs("aside", { className: "md:sticky md:top-0 md:h-[calc(100vh-52px)] w-full md:w-[240px] shrink-0 border-b md:border-b-0 md:border-r border-[var(--z-border)] bg-[color-mix(in_oklab,var(--z-surface),black_10%)]", children: [_jsxs("div", { className: "px-5 py-4 border-b border-[var(--z-border)]", children: [_jsx("div", { className: "text-[10px] font-semibold uppercase tracking-wider text-[var(--z-muted)]", children: "Curriculum" }), _jsx("div", { className: "mt-1 text-base font-semibold text-[var(--z-fg)] truncate", children: tenantLabel })] }), _jsx("nav", { className: "flex md:block overflow-x-auto md:overflow-visible px-2 py-3 gap-1 md:gap-0 md:space-y-0.5", children: CURRICULUM_NAV.map((item) => {
