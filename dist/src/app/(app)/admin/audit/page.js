...
export default async function AdminAuditPage({ searchParams, }) {
    ...
    return (_jsxs("div", { className: "flex flex-col gap-6 p-6", children: [_jsxs("header", { children: [_jsx("div", { className: "text-xs uppercase tracking-wider text-[var(--z-muted)]", children: "Admin OS" }), _jsx("h1", { className: "text-2xl font-bold text-[var(--z-fg)]", children: "Audit log" }), _jsx("p", { className: "text-sm text-[var(--z-muted)]", children: "Every privileged action. Settings and role changes include a diff." })] }), _jsx(AuditLogTable, { tenantId: tenantId, entries: rows })] }));
}
