...
export function StudentSidebar({ allowedNavIds, onNavigate, }) {
    return (_jsx(PortalSidebarNav, { label: "Student Portal", items: STUDENT_NAV_ITEMS, allowedNavIds: allowedNavIds, onNavigate: onNavigate }));
}
