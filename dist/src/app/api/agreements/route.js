...
export async function GET(req) {
    ...
    try {
        ...
        if (error)
            throw error;
        return ok({ data, count: (_a = data === null || data === void 0 ? void 0 : data.length) !== null && _a !== void 0 ? _a : 0 });
    }
    catch (err) {
...
export async function POST(req) {
    ...
    try {
        ...
        const { data: row, error } = await supabase
            ...
            url: (_a = parsed.data.url) !== null && _a !== void 0 ? _a : null,
            signed: (_b = parsed.data.signed) !== null && _b !== void 0 ? _b : false,
...
export async function PATCH(req) {
    try {
        ...
        const supabase = getServiceClient();
        const patch = { signed: parsed.data.signed };
        if (parsed.data.url)
        ...
        if (parsed.data.signed) {
            ...
            processAgentEvent(signedEvent).catch((e) => console.error("[agreements] Agent event processing failed:", e));
        }
        return ok({ data: row });
    }
    catch (err) {
