import { z } from "zod";
import { deleteAIConversation, getAIConversationById, updateAIConversation, } from "@data/aiConversations";
...
export async function PATCH(req, ctx) {
    try {
        ...
        const row = await updateAIConversation(id, tenantId, parsed.data);
        return ok({ data: row });
    }
    catch (err) {
        return serverError(err);
