import { z } from "zod";
import { endEnrollment, getEnrollment, updateEnrollment, } from "@/lib/crm";
...
export async function PATCH(req, ctx) {
    ...
    try {
        ...
        const row = await updateEnrollment(resolved.context.tenantId, id, parsed.data);
        return ok({ data: row });
    }
    catch (err) {
        return serverError(err);
...
export async function DELETE(req, ctx) {
    ...
    try {
        ...
        if (opts === null || opts === void 0 ? void 0 : opts.end) {
