...
import { getOptionalAdminHourlyUsd, getOptionalEnrollmentUsd, getOptionalHoursPerEnrollment, } from "@/components/dashboard/impactEstimates";
export function linesForAgent(id, metrics, signals) {
...
export function askActionForAgent(id) {
    switch (id) {
        case "star":
