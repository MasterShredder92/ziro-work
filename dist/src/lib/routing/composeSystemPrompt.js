...
export function composeSystemPrompt(template, skills, taskDescription) {
    const parts = [];
    // 1. STAR base prompt
...
export function composeSpecialistExecutionPrompt(agent, skills, taskDescription) {
    var _a, _b;
    const parts = [];
    parts.push(`You are ${agent.name} — ${agent.role}.`);
    if ((_a = agent.instructions) === null || _a === void 0 ? void 0 : _a.trim()) {
        parts.push("\n--- YOUR OPERATING INSTRUCTIONS ---\n");
        parts.push(agent.instructions.trim());
    }
    else if ((_b = agent.system_prompt) === null || _b === void 0 ? void 0 : _b.trim()) {
        parts.push("\n--- SYSTEM PROMPT ---\n");
