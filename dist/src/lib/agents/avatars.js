 ...
 */
export function getAgentAvatarFilename(input) {
    var _a;
    const slug = normalizeSlug((_a = input.slug) !== null && _a !== void 0 ? _a : input.agentId);
    if (!slug)
        return null;
...
export function getAgentAvatarFilenameByAgentId(agentId) {
    return getAgentAvatarFilename({ agentId });
}
export function getAgentAvatarUrlByAgentId(agentId) {
