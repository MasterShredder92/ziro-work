...
export const ALL_PERMISSION_KEYS = Array.from(new Set(PERMISSION_BUNDLES.flatMap((b) => b.permissions))).sort();
export function getBundle(key) {
    var _a;
    return (_a = PERMISSION_BUNDLES.find((b) => b.key === key)) !== null && _a !== void 0 ? _a : null;
}
export function bundleForPermission(permission) {
    var _a;
    return ((_a = PERMISSION_BUNDLES.find((b) => b.permissions.includes(permission))) !== null && _a !== void 0 ? _a : null);
}
