...
const SOURCE_FETCHERS = {
    students: (t) => safeFetch(() => listStudents(t, undefined, { limit: SAFETY_LIMIT })),
    families: (t) => safeFetch(() => listFamilies(t, undefined, { limit: SAFETY_LIMIT })),
    teachers: (t) => safeFetch(() => listTeachers(t, undefined, { limit: SAFETY_LIMIT })),
    leads: (t) => safeFetch(() => listLeads(t, undefined, { limit: SAFETY_LIMIT })),
    schedule_blocks: (t) => safeFetch(() => listScheduleBlocks(t, undefined, { limit: SAFETY_LIMIT })),
    lesson_events: (t) => safeFetch(() => listLessonEvents(t, undefined, { limit: SAFETY_LIMIT })),
    attendance_sessions: (t) => safeFetch(() => listAttendanceSessions({}, t, { limit: SAFETY_LIMIT })),
    invoices: (t) => safeFetch(() => listInvoices(t, undefined, { limit: SAFETY_LIMIT })),
    payments: (t) => safeFetch(() => listPayments(t, undefined, { limit: SAFETY_LIMIT })),
    subscriptions: (t) => safeFetch(() => listSubscriptions(t, undefined, { limit: SAFETY_LIMIT })),
    progress_goals: (t) => safeFetch(() => listGoals({}, t, { limit: SAFETY_LIMIT })),
    progress_skills: (t) => safeFetch(() => listSkills({}, t, { limit: SAFETY_LIMIT })),
    progress_checkpoints: (t) => safeFetch(() => listCheckpoints({}, t, { limit: SAFETY_LIMIT })),
    progress_evidence: (t) => safeFetch(() => listEvidence({}, t, { limit: SAFETY_LIMIT })),
    assessments: (t) => safeFetch(() => listAssessments(t, undefined, { limit: SAFETY_LIMIT })),
    assessment_attempts: (t) => safeFetch(() => listAssessmentAttempts({}, t, { limit: SAFETY_LIMIT })),
    forms: (t) => safeFetch(() => listForms(t)),
    form_submissions: (t) => safeFetch(() => listFormSubmissions(t)),
    message_threads: (t) => safeFetch(() => listThreads(t, undefined, { limit: SAFETY_LIMIT })),
    messages: (t) => safeFetch(() => listMessages(t, undefined, { limit: SAFETY_LIMIT })),
    automation_runs: (t) => safeFetch(() => listAutomationRuns(t, undefined, { limit: SAFETY_LIMIT })),
    automation_logs: (t) => safeFetch(() => listAutomationLogs(t, undefined, { limit: SAFETY_LIMIT })),
};
/**
 ...
 */
export async function fetchSource(source, tenantId) {
    const fetcher = SOURCE_FETCHERS[source];
    if (!fetcher)
        return [];
    return fetcher(tenantId);
}
export function isKnownSource(v) {
