...
const rules = [
    {
        ...
        binding: {
            ...
            guidance: "Theme editor — tune palette, typography, and preview before publish.",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["ruby", "stewie", "vader"],
            guidance: "Custom domain — add a hostname, verify CNAME, then activate.",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["ruby", "stewie", "vader"],
            guidance: "Branding OS — logos, theme, domain, email identity, and portal layouts.",
            label: "Branding",
            quickActions: [
                {
                    id: "theme",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["ruby", "stewie", "vader"],
            guidance: "Tenant administration — roles, permissions, settings, flags, audit.",
            label: "Admin",
            quickActions: [
                {
                    id: "roles",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Design roles & permission bundles. Safe updates prevent admin lockout.",
    ...
    {
        match: (p) => p.startsWith("/admin/settings") || p.startsWith("/admin/feature-flags"),
        binding: {
            pageType: "admin_settings",
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader"],
            guidance: "Tenant branding, billing/scheduling/messaging settings, feature flags.",
    ...
    {
        match: (p) => p.startsWith("/admin/audit") || p.startsWith("/admin/system-health"),
        binding: {
            pageType: "admin_audit",
            primaryAgentId: "ziro",
            secondaryAgentIds: ["ruby"],
            guidance: "Search audit entries, review diffs, export CSV. Investigate anomalies.",
            label: "Audit & health",
            quickActions: [
                {
                    id: "export",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Contact surface — review timeline, message, qualify, or schedule a follow-up.",
            label: "Contact",
            quickActions: [
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Student profile — review schedule, progress, attendance, and billing.",
            label: "CRM Student",
            quickActions: [
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Student billing — review this invoice in context of the student record.",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Lesson under this student’s progress — resolve conflicts or queue follow-ups.",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Student progress hub — goals, skills, and evidence for this learner.",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Family profile — message householders, review billing, and manage linked students.",
            label: "CRM Family",
            quickActions: [
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Teacher profile — review load, availability, and assigned students.",
            label: "CRM Teacher",
            quickActions: [
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Lead pipeline — move stages, convert to students, and queue follow-ups.",
            label: "CRM Leads",
            quickActions: [
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Enrollment manager — filter by teacher or status, then save inline updates.",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "CRM OS — contacts, students, families, teachers, and enrollments.",
            label: "CRM",
            quickActions: [
                { id: "contacts", label: "Contacts", icon: "Users", intent: "nav", href: "/crm/contacts" },
                { id: "students", label: "Students", icon: "GraduationCap", intent: "nav", href: "/crm/students" },
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Browse this folder — move items, edit tags, or open the editor.",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Edit content, add assets, and publish new versions.",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Content Library — browse, search, and curate learning materials.",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Design reusable templates with merge fields for families, teachers, and students.",
            label: "Templates",
            quickActions: [
                {
                    id: "new-template",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Edit template content, preview with sample data, and publish a new version.",
    ...
    {
        match: (p) => /^\/files\/signatures\/(?!new$)[^/]+$/.test(p) || /^\/files\/sign\//.test(p),
        binding: {
            pageType: "signature_request",
            primaryAgentId: "stewie",
            secondaryAgentIds: ["vader", "ziro"],
            guidance: "Signature request — track status, nudge signers, or schedule a follow-up.",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "stewie",
            secondaryAgentIds: ["vader", "ziro"],
            guidance: "Signature inbox — compose a request, assign signers and fields, then track completion.",
            label: "Signatures",
            quickActions: [
                {
                    id: "files-home",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "File explorer — search, virtualized lists, multi-select, move/rename, folder tree, uploads.",
            label: "File explorer",
            quickActions: [
                {
                    id: "back",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Manage share links — regenerate tokens, one-time view, expiry, and access limits.",
            label: "Share links",
            quickActions: [
                {
                    id: "explorer",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "File surface — preview, versions, permissions, share links, and signatures.",
            label: "File",
            quickActions: [
                {
                    id: "back",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Public share link — expiry, password, view cap, disabled links, and watermarks.",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Files & Documents OS — upload, organize, share, and request signatures.",
            label: "Files",
            quickActions: [
                {
                    id: "explorer",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Design dynamic forms, monitor submissions, and wire automations on submit.",
            label: "Forms",
            quickActions: [
                {
                    id: "new-form",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Review a submission, qualify the submitter, and queue follow-ups.",
            label: "Submission",
            quickActions: [
                {
                    id: "qualify-lead",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["star", "stewie", "vader"],
            guidance: "Edit form fields, preview, and analyze submission KPIs & drop-off.",
            label: "Form",
            quickActions: [
                {
                    id: "back",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ruby",
            secondaryAgentIds: ["stewie", "ziro", "star"],
            guidance: "Review this lesson — schedule it, detect conflicts, or queue a follow-up.",
            label: "Lesson",
            quickActions: [
                {
                    id: "detect-conflicts",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Programs, levels, and lessons at a glance — run a KPI snapshot or schedule a curriculum follow-up.",
            label: "Curriculum",
            quickActions: [
                {
                    id: "kpis",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "ruby", "star"],
            guidance: "Program surface — review levels, lessons, and enrollment interest.",
            label: "Program",
            quickActions: [
                {
                    id: "kpis",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Session roster — quick-mark attendance, add reasons, override records.",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Attendance OS — monitor rates, streaks, risk flags, and upcoming sessions.",
            label: "Attendance",
            quickActions: [
                {
                    id: "kpis",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Student attendance — rate, streaks, flags, and recent records.",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Student Progress OS — pick a student to review goals, skills, and evidence.",
            label: "Progress",
            quickActions: [
                {
                    id: "kpis",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Progress surface — review this student's goals, skills, checkpoints, and evidence.",
            label: "Student Progress",
            quickActions: [
                {
                    id: "kpis",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Review this attempt — grade rubric items, send feedback, or schedule a review lesson.",
            label: "Attempt",
            quickActions: [
                {
                    id: "message-student",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["vader", "stewie", "ruby"],
            guidance: "Runner view — answer each question, then submit to trigger auto-scoring.",
            label: "Runner",
            quickActions: [],
        },
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["vader", "stewie", "ruby"],
            guidance: "Assessments OS — review KPIs, message students, or queue follow-ups.",
            label: "Assessments",
            quickActions: [
                {
                    id: "kpis",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["vader", "stewie", "ruby"],
            guidance: "Assessment surface — questions, rubric, and attempts. Run KPIs or schedule follow-ups.",
            label: "Assessment",
            quickActions: [
                {
                    id: "kpis",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Workflow surface — tune triggers, actions, retries, and concurrency.",
            label: "Workflow",
            quickActions: [
                {
                    id: "back",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Run surface — step timeline, logs, retries, and escalations.",
            label: "Run",
            quickActions: [
                {
                    id: "back",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Inventory OS — track assets, stock, checkouts, maintenance, and depreciation.",
            label: "Inventory",
            quickActions: [
                {
                    id: "kpis",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ziro",
            secondaryAgentIds: ["stewie", "vader", "ruby"],
            guidance: "Asset surface — stock, checkouts, maintenance, and depreciation curve.",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ruby",
            secondaryAgentIds: ["stewie", "vader", "ziro"],
            guidance: "Event surface — reschedule, reassign, detect conflicts, or message the teacher.",
            label: "Event",
            quickActions: [
                {
                    id: "back",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Room surface — review bookings, capacity, and equipment. Resolve overlaps with detect conflicts.",
            label: "Room",
            quickActions: [
                {
                    id: "back",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "ruby",
            secondaryAgentIds: ["ziro", "stewie", "vader"],
            guidance: "Schedule & Calendar OS — week/month views, availability, rooms, and conflicts.",
            label: "Schedule",
            quickActions: [
                {
                    id: "new-event",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "bub",
            secondaryAgentIds: ["ziro", "vader", "stewie", "ruby"],
            guidance: "Invoice surface — review line items, record payments, or send a reminder.",
            label: "Invoice",
            quickActions: [
                {
                    id: "back",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "bub",
            secondaryAgentIds: ["ziro", "vader", "stewie", "ruby"],
            guidance: "Subscription surface — review plan, renewals, and generate recurring invoices.",
            label: "Subscription",
            quickActions: [
                {
                    id: "back",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "bub",
            secondaryAgentIds: ["ziro", "vader", "stewie", "ruby"],
            guidance: "Billing OS — track revenue, aging, overdue, and upcoming renewals.",
            label: "Billing",
            quickActions: [
                {
                    id: "new-invoice",
    ...
    },
    {
        ...
        binding: {
            ...
            guidance: "Conversation surface — reply, attach a template, detect follow-ups, or message a teacher.",
            label: "Thread",
            quickActions: [
                {
                    id: "back",
    ...
    },
    {
        ...
        binding: {
            ...
            primaryAgentId: "vader",
            secondaryAgentIds: ["stewie", "ruby", "ziro"],
            guidance: "Messaging OS — triage your inbox, draft templates, or schedule follow-ups.",
            label: "Messaging",
            quickActions: [
                {
                    id: "message-teacher",
...
function rulePriority(rule, ruleIndex) {
    if (rule.specificity != null)
        return rule.specificity;
    return 10000 - ruleIndex;
}
function applyRecommendedSkillsFromPageType(binding) {
    var _a;
    if (binding.pageType) {
        const recommended = PAGE_RECOMMENDED_SKILLS[binding.pageType];
        if (recommended && recommended.length > 0 && !((_a = binding.recommendedSkills) === null || _a === void 0 ? void 0 : _a.length)) {
            return Object.assign(Object.assign({}, binding), { recommendedSkills: recommended });
        }
    }
    return binding;
}
 ...
 */
export function canonicalAgentOSPathname(pathname) {
...
export function getPageBinding(pathname) {
    ...
    if (best === null) {
        return applyRecommendedSkillsFromPageType(Object.assign({}, DEFAULT_BINDING));
    }
    return applyRecommendedSkillsFromPageType(Object.assign({}, best.rule.binding));
}
export function getPageRecommendedSkills(pageType) {
    const key = pageType in PAGE_RECOMMENDED_SKILLS
        ? pageType
        : null;
    if (!key)
        return [];
...
export function getPageTypeFromPathname(pathname) {
    ...
    return (_a = binding.pageType) !== null && _a !== void 0 ? _a : "dashboard";
}
