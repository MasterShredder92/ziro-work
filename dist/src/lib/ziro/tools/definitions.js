export const AGENT_TOOLS = [
    {
        name: "update_student",
        description: "Update a student's profile fields. Use this to save bio, goals, learning style, prior experience/notes, teacher notes, or any other writable student field. Always confirm what you wrote back to the user.",
        input_schema: {
            type: "object",
            properties: {
                student_id: {
    ...
    {
        name: "get_student",
        description: "Fetch a student's current profile data including bio, goals, learning style, experience, instrument, teacher, status, and notes.",
        input_schema: {
            type: "object",
            properties: {
                student_id: {
    ...
    },
    {
        ...
        description: "Check a teacher's available time slots for a given date range. Use before rescheduling.",
        input_schema: {
            type: "object",
            properties: {
                teacher_id: {
    ...
    },
    {
        ...
        description: "Move a schedule block to a new date/time or assign it to a different teacher. Use this when a student or teacher needs to reschedule a lesson.",
        input_schema: {
            type: "object",
            properties: {
                block_id: {
    ...
    },
    {
        ...
        description: "List schedule blocks for a student or teacher within a date range.",
        input_schema: {
            type: "object",
            properties: {
                student_id: {
...
export function getToolsForAgent(agentName) {
    ...
    if (!agentName)
        return [];
    const allowed = (_a = AGENT_TOOL_MAP[agentName.toLowerCase()]) !== null && _a !== void 0 ? _a : [];
