...
async function runViaPgQuery(url, serviceKey, sql) {
...
async function applyMigrationFile(filePath, exec) {
...
async function main() {
    ...
    console.log("");
    console.log(`Summary: ${results.length - failed.length}/${results.length} migrations applied.`);
    try {
