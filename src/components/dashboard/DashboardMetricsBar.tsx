...
export function DashboardMetricsBar() {
  ...
  return (
    <section className="flex gap-3 overflow-x-auto pb-1 sm:grid sm:grid-cols-3 sm:overflow-visible xl:grid-cols-6">
      <Link href="/crm/families" className="min-w-[9rem] flex-shrink-0 sm:min-w-0 sm:flex-shrink block">
        <DashboardMetricCard
      ...
      <Link href="/invoices?status=PAID" className="min-w-[9rem] flex-shrink-0 sm:min-w-0 sm:flex-shrink block">
        <DashboardMetricCard
      ...
      <Link href="/invoices" className="min-w-[9rem] flex-shrink-0 sm:min-w-0 sm:flex-shrink block">
        <DashboardMetricCard
      ...
      <Link href="/invoices?status=UNPAID" className="min-w-[9rem] flex-shrink-0 sm:min-w-0 sm:flex-shrink block">
        <DashboardMetricCard
          label="Outstanding"
      ...
      {/* Next Month — forward-looking, no drill-down */}
      <div className="min-w-[9rem] flex-shrink-0 sm:min-w-0 sm:flex-shrink">
        <DashboardMetricCard
          label="Next Month"
      ...
      <Link href="/invoices?status=SCHEDULED" className="min-w-[9rem] flex-shrink-0 sm:min-w-0 sm:flex-shrink block">
        <DashboardMetricCard
          label="Scheduled"
