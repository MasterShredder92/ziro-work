...
export function ChampionshipReportCard({ report, studentName }: ChampionshipReportCardProps) {
  ...
  return (
    <div className="rounded-lg border border-[#1c1c1e] bg-[#0a0a0c] p-4 hover:border-[#c4f036]/30 transition-colors">
      {/* Header */}
      <div className="flex items-start justify-between gap-4">
        ...
        {report.content?.status && (
          <span className="inline-flex items-center rounded-full bg-[#c4f036]/10 px-2.5 py-0.5 text-xs font-semibold text-[#c4f036]">
            {report.content.status}
          </span>
        )}
      </div>
        ...
        {report.file_url && (
          <>
            ...
            <a
              ...
              download
              className="flex-1 inline-flex items-center justify-center gap-2 rounded-md bg-[#c4f036]/10 px-3 py-2 text-xs font-semibold text-[#c4f036] hover:bg-[#c4f036]/20 transition-colors"
            >
