    ...
    Tables: {
      ...
      agent_tasks: {
        Row: {
          ...
          review_status: Database["public"]["Enums"]["review_verdict"] | null
          review_summary: string | null
          routed_at: string | null
          runtime: Database["public"]["Enums"]["skill_runtime"] | null
          skill_ids: Json
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "agent_tasks_agent_template_id_fkey"
          ...
          {
            foreignKeyName: "agent_tasks_template_id_fkey"
            columns: ["template_id"]
            isOneToOne: false
            referencedRelation: "agent_templates"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "agent_tasks_thread_id_fkey"
            columns: ["thread_id"]
            isOneToOne: false
      ...
      agent_template_skills: {
        ...
        Relationships: [
          {
            foreignKeyName: "agent_template_skills_agent_template_id_fkey"
            columns: ["agent_template_id"]
            isOneToOne: false
            referencedRelation: "agent_templates"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "agent_template_skills_skill_id_fkey"
            columns: ["skill_id"]
            isOneToOne: false
            referencedRelation: "skills"
            referencedColumns: ["id"]
      ...
      agenteventsubscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "agenteventsubscriptions_agentid_fkey"
            columns: ["agentid"]
            isOneToOne: false
      ...
      agents: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "agents_zirorb_id_fkey"
            columns: ["zirorb_id"]
            isOneToOne: false
            referencedRelation: "zirorbs"
            referencedColumns: ["id"]
          },
        ]
      }
      agenttoolassignments: {
        ...
        Relationships: [
          {
            foreignKeyName: "agenttoolassignments_agentid_fkey"
            columns: ["agentid"]
            isOneToOne: false
            referencedRelation: "ziro_agents"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "agenttoolassignments_skillid_fkey"
            columns: ["skillid"]
            isOneToOne: false
      ...
      lesson_notes: {
        ...
        Relationships: [
          {
            foreignKeyName: "lesson_notes_agentid_fkey"
            columns: ["agentid"]
            isOneToOne: false
            referencedRelation: "ziro_agents"
            referencedColumns: ["id"]
      ...
      skills: {
        Row: {
          ...
          name: string
          output_schema: Json
          preferred_runtime: Database["public"]["Enums"]["skill_runtime"]
      ...
      star_reviews: {
        ...
        Relationships: [
          {
            foreignKeyName: "star_reviews_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
      ...
      task_artifacts: {
        ...
        Relationships: [
          {
            foreignKeyName: "task_artifacts_run_id_fkey"
            columns: ["run_id"]
            isOneToOne: false
      ...
      task_failures: {
        ...
        Relationships: [
          {
            foreignKeyName: "task_failures_run_id_fkey"
            columns: ["run_id"]
            isOneToOne: false
            referencedRelation: "task_runs"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "task_failures_task_id_fkey"
            columns: ["task_id"]
            isOneToOne: false
            referencedRelation: "agent_tasks"
            referencedColumns: ["id"]
      ...
      task_runs: {
        Row: {
          ...
          runtime: Database["public"]["Enums"]["skill_runtime"]
      ...
      task_threads: {
        ...
        Relationships: [
          {
            foreignKeyName: "task_threads_agent_id_fkey"
            columns: ["agent_id"]
            isOneToOne: false
            referencedRelation: "agents"
            referencedColumns: ["id"]
      ...
      ziro_agents: {
        ...
        Relationships: [
          {
            foreignKeyName: "ziro_agents_permissionsprofileid_fkey"
            columns: ["permissionsprofileid"]
            isOneToOne: false
            referencedRelation: "agentpermissionprofiles"
            referencedColumns: ["id"]
          },
        ]
      }
