...
const generateInvoice: SkillDefinition = {
...
const listOutstanding: SkillDefinition = {
...
const recordPayment: SkillDefinition = {
    ...
    return {
      result: {
        ...
        payment: {
          ...
          currency: "USD",
          method,
          occurredAt: tokens.date ?? new Date().toISOString().slice(0, 10),
...
const invoiceAgingReport: SkillDefinition = {
...
const reconcileSquare: SkillDefinition = {
