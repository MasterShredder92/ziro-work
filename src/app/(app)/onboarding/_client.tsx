...
export function OnboardingClient() {
  ...
  const steps: OnboardingChecklistItem[] = React.useMemo(
    () => {
      void tick;
      return [
      {
  ...
  return (
    <PageShell>
      <div className="mx-auto flex max-w-3xl flex-col gap-[var(--z-space-8)]">
        <PageHeader
          title="Welcome to ZiroWork"
          subtitle="A founder-grade checklist to light up your studio in minutes."
        />
