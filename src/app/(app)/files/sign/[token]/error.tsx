...
export default function SignLinkError({
  error,
  reset,
}: {
  ...
  return (
    <div className="mx-auto max-w-md rounded-md border border-red-500/35 bg-red-500/10 p-6 text-sm text-red-100">
      <h2 className="text-base font-semibold text-red-50">Could not open this signing link</h2>
      <p className="mt-2 text-xs leading-relaxed">
        {error.message || "The link may be invalid or no longer active."}
      </p>
      <button
        type="button"
        onClick={reset}
