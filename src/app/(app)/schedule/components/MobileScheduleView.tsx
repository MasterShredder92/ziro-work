            ...
            <div>
              ...
              <div className="relative">
                <select value={blockType}
                  ...
                  className="w-full rounded-lg border bg-[var(--z-surface)] pl-9 pr-3 py-2 text-sm text-[var(--z-fg)] focus:outline-none appearance-none"
                  style={{ borderColor: "var(--z-border)" }}>
                ...
                <div 
                  ...
                  style={{ 
                    backgroundColor: blockStyle({ ...block, block_type: blockType as any }).bg,
                    borderColor: blockStyle({ ...block, block_type: blockType as any }).border
                  }}
                />
