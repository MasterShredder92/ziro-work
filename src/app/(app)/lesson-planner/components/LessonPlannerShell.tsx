...
import { LessonPlannerSidebar } from "./LessonPlannerSidebar";

export function LessonPlannerShell({
  children,
  tenantLabel,
  generatedAt,
}: {
  ...
  return (
    <div className="h-full flex flex-col min-h-0">
        ...
        <div className="flex items-center gap-3 min-w-0">
          ...
          <div className="min-w-0">
            ...
            <div className="text-sm font-semibold text-[var(--z-fg)] truncate">
              Objectives · activities · materials · versions · AI drafts
            </div>
          </div>
        </div>
        {generatedAt ? (
      ...
      <div className="flex-1 min-h-0 flex flex-col md:flex-row">
        <LessonPlannerSidebar tenantLabel={tenantLabel} />
