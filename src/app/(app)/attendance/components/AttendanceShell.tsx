    ...
    <div className="h-full flex flex-col min-h-0">
      <div className="shrink-0 flex flex-col sm:flex-row sm:items-center gap-3 px-4 sm:px-6 py-3 border-b border-[var(--z-border)] bg-[color-mix(in_oklab,var(--z-surface-2),transparent_12%)]">
        <div className="flex items-center gap-3 min-w-0">
          <div className="h-8 w-8 rounded-full bg-[#00ffd0]/15 border border-[#00ffd0]/30 flex items-center justify-center text-[#00ffd0] font-bold text-sm">
            A
          </div>
      ...
      <div className="flex-1 min-h-0 flex flex-col md:flex-row">
        <AttendanceSidebar tenantLabel={tenantLabel} />
